...
- 夜フェーズ: 人狼が1人を襲撃 / 占い師が1人を占う / 狩人が1人を護衛
- 霊媒師は処刑されたプレイヤーが人狼だったかどうかを翌朝知る
- 村人陣営の勝利条件: 人狼を全員処刑する
- 人狼陣営の勝利条件: 村人陣営の生存者が人狼の数以下になる
- 投票は公開（誰が誰に投票したか全員に見える）
- 処刑されたプレイヤーの役職は公開されない
- 1日目の昼は最初のフェーズであり、まだ夜が来ていないため占い結果・霊媒結果は存在しない

## 戦略の基本
- 村人陣営にとって情報収集が最も重要。情報の信頼度は 占い結果 > 霊媒結果 > 議論 の順
- 人狼陣営はこれらの情報を偽って村を混乱させることが重要
- 占い師が複数名乗り出た場合、狂人や人狼の偽占い師の可能性が高い。どちらが本物か慎重に見極めてから投票先を決めましょう
- 自分が人狼だと名指しされた場合は、必ず反論してください。告発者の信頼性を疑い、自分の潔白を主張しましょう
...
- 人狼に襲撃されないよう注意しつつも、情報を村に提供することを優先しましょう""",
    Role.WEREWOLF: """\
## あなたの役職: 人狼
...
- 占いCOすることで本物の占い師の信頼を下げ、村の情報精度を落とすことが狙いです""",
}
