...
- 占い結果や霊媒結果が共有されたら、その情報を重視して投票先を判断してください
...
- 例: 「私は占い師です。○○さんを占った結果、白/黒でした」と明確に伝える
- 狩人があなたを護衛してくれる可能性が高いので、早めにカミングアウトして情報を共有することが有効です
...
- 占い師に黒出しされた場合は、その占い師を偽物だと主張して対抗しましょう""",
    Role.KNIGHT: """\
## あなたの役職: 狩人
...
- 例: 「私は占い師です。○○さんを占った結果、黒（人狼）でした」と村人に偽の黒出しをする
